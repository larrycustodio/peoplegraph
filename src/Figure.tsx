const STATUS_MAP: Record<string, string> = {
  default: "fill-gray-50",
  unharmed: "fill-gray-400",
  benefit: "fill-green-700",
  harm: "fill-red-500",
};
